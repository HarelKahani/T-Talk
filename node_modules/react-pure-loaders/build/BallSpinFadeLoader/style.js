...
var radius = '25px';
var ballSpinFade = (0, _core.keyframes)({
  '100%': {
    opacity: 1,
    transform: 'scale(1)'
  },
  ...
  for (; i < 9; i += 1) {
    ...
    if (i === 1) {
      grid["> div:nth-of-type(".concat(i, ")")] = {
        animation: "".concat(ballSpinFade, " 1s ").concat((0, _utilities["default"])('0.12s', n, i - 1), " infinite linear"),
        left: 0,
        top: radius
      };
    } else if (i === 2) {
...
var _default = function _default(color) {
  return _objectSpread({}, ballSpinFadeLoader(), {
    left: '-10px',
    position: 'relative',
    top: '-10px',
